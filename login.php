...
<html>
  <head>
    ...
    <title><?php echo $site_nama_sekolah; ?> - Login SIAKAD</title>
    <link href='<?php echo $site_logo; ?>' rel='shortcut icon'>
    <meta name="author" content="https://smputama.sch.id/">
  ...
  <body class="hold-transition login-page">
    <div class="login-box">
      <div class="login-logo">
        <img src="<?php echo $site_logo; ?>" alt="Logo" style="height:52px;width:52px;object-fit:contain;border-radius:14px;background:#fff;padding:4px;box-shadow:0 6px 16px rgba(0,0,0,.15);margin-bottom:8px;">
        <br><b><?php echo $site_nama_sekolah; ?></b>
      </div><!-- /.login-logo -->
