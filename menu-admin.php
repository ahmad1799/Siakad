<section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li><a href="index.php?view=journalkbm"><i class="fa fa-tags"></i><span>Catatan KBM</span></a></li>
            ...
            <li><a href="index.php?view=dokumentasi"><i class="fa fa-book"></i> <span>Panduan</span></a></li>
          </ul>
        </section>