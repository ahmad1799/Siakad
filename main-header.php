  ...
  .sekolah:hover{
    color:#fff;
        ...
        <a href="index.php" class="logo">
          ...
          <span class="logo-mini"><img src="<?php echo $site_logo; ?>" alt="Logo" style="height:30px;width:30px;object-fit:contain;border-radius:8px;background:#fff;padding:2px;"></span>
          <!-- logo for regular state and mobile devices -->
          <span class="logo-lg" style="display:flex;align-items:center;gap:8px;">
            <img src="<?php echo $site_logo; ?>" alt="Logo" style="height:26px;width:26px;object-fit:contain;border-radius:6px;background:#fff;padding:2px;">
            <b><?php echo $site_nama_sekolah; ?></b>
          </span>
        </a>
