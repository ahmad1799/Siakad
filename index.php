...
<html>
  <head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
      <link href='<?php echo $site_logo; ?>' rel='shortcut icon'>
      <link href='<?php echo $site_logo; ?>' rel='icon' type='image/png'>
    <title><?php echo $site_nama_sekolah; ?> - Sistem Informasi Akademik Sekolah</title>
    <meta name="author" content="<?php echo $site_nama_sekolah; ?>">
    <meta property="og:site_name" content="<?php echo $site_nama_sekolah; ?>">
    <meta property="og:title" content="<?php echo $site_nama_sekolah; ?> - Sistem Informasi Akademik Sekolah">
    <meta property="og:image" content="<?php echo $site_logo; ?>">
    <script type="application/ld+json">
    {
      "@context": "https://schema.org",
      "@type": "Organization",
      "name": "<?php echo addslashes($site_nama_sekolah); ?>",
    ...
    <!-- Modern Theme Overlay (upgrade tampilan, tidak mengubah logika PHP) -->
    <link rel="stylesheet" href="dist/css/custom/custom-modern-theme.css">
    <!-- iCheck -->
  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        <?php 
          if (isset($_GET['view']) && ($_GET['view']=='home' OR $_GET['view']=='')){
              if($_SESSION['level']=='siswa'){
          ...
          elseif (isset($_GET['view']) && $_GET['view']=='psbmenu'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/psb_menu.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='psbhalaman'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/psb_halaman.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='psbsma'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/psb_pendaftaran.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='psbsmk'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/psb_pendaftaran.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='psbsmp'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/psb_pendaftaran.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='psbaktivasi'){
            cek_session_admin();
            echo "<div class='row'>";
          ...
          elseif (isset($_GET['view']) && $_GET['view']=='journalkbm'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/journal_semua.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='journalguru'){
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/journal_guru.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='kompetensiguru'){
            cek_session_guru();
            echo "<div class='row'>";
          ...
          elseif (isset($_GET['view']) && $_GET['view']=='siswa'){
            echo "<div class='row'>";
                    include "application/master_siswa.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='guru'){
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/master_guru.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='wakilkepala'){
            cek_session_admin();
            echo "<div class='row'>";
            ...
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='kelas'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_kelas.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='tahunakademik'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_tahun_akademik.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='gedung'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_gedung.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='ruangan'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_ruangan.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='golongan'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_golongan.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='ptk'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_ptk.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='matapelajaran'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_matapelajaran.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='jadwalpelajaran'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_jadwalpelajaran.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='jurusan'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_jurusan.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='kurikulum'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_kurikulum.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='predikat'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_predikat.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='statuspegawai'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_statuspegawai.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='identitas'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_identitas.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='kelompokmapel'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_kelompokmapel.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='kompetensidasar'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_kompetensidasar.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='penilaiandiri'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/master_penilaiandiri.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='penilaianteman'){
            cek_session_admin();
            echo "<div class='row'>";
          ...
          elseif (isset($_GET['view']) && $_GET['view']=='absensiswa'){
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/absensi_siswa.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='rekapabsensiswa'){
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/absensi_siswa_rekap.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='absenguru'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/absensi_guru.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='bahantugas'){
            echo "<div class='row'>";
                    include "application/bahan_tugas.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='soal'){
            echo "<div class='row'>";
                    include "application/quiz_ujian_soal.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='forum'){
            echo "<div class='row'>";
                    include "application/forum_diskusi.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='penilaiandirisiswa'){
            echo "<div class='row'>";
                    include "application/penilaiandiri_siswa.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='penilaiantemansiswa'){
            echo "<div class='row'>";
          ...
          elseif (isset($_GET['view']) && $_GET['view']=='raport'){
            echo "<div class='row'>";
                    include "application/raport.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='raportuts'){
            echo "<div class='row'>";
                    include "application/raport_uts.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='raportcetak'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/raport_cetak.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='raportcetakuts'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/raport_cetak_uts.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='capaianhasilbelajar'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/raport/raport_capaian_hasil_belajar.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='extrakulikuler'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/raport/raport_extrakulikuler.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='prestasi'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/raport/raport_prestasi.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='bukuinduk'){
            cek_session_admin();
            echo "<div class='row'>";
          ...
          elseif (isset($_GET['view']) && $_GET['view']=='dokumentasi'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/dokumentasi.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='dokumentasiguru'){
            cek_session_guru();
            echo "<div class='row'>";
                    include "application/dokumentasi_guru.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='dokumentasisiswa'){
            cek_session_siswa();
            echo "<div class='row'>";
          ...
          elseif (isset($_GET['view']) && $_GET['view']=='sms'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/sms/sms.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='broadcast'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/sms/broadcast.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='autoreply'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/sms/autoreply.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='smstoweb'){
            cek_session_admin();
            echo "<div class='row'>";
                    include "application/sms/sms_to_web.php";
            echo "</div>";
          }elseif (isset($_GET['view']) && $_GET['view']=='outboxautoreply'){
            cek_session_admin();
            echo "<div class='row'>";
    ...
    <div class="modal fade" id="nilaiessai" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method='POST' action='index.php?view=soal&act=semuajawabansiswa&jdwl=<?php echo isset($_GET['jdwl']) ? $_GET['jdwl'] : ''; ?>&idsoal=<?php echo isset($_GET['idsoal']) ? $_GET['idsoal'] : ''; ?>&id=<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>&kd=<?php echo isset($_GET['kd']) ? $_GET['kd'] : ''; ?>&noinduk=<?php echo isset($_GET['noinduk']) ? $_GET['noinduk'] : ''; ?>' class="form-horizontal">
    ...
    <div class="modal fade" id="essai" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <form method='POST' action='index.php?view=soal&act=semuasoal&jdwl=<?php echo isset($_GET['jdwl']) ? $_GET['jdwl'] : ''; ?>&idsoal=<?php echo isset($_GET['idsoal']) ? $_GET['idsoal'] : ''; ?>&id=<?php echo isset($_GET['id']) ? $_GET['id'] : ''; ?>&kd=<?php echo isset($_GET['kd']) ? $_GET['kd'] : ''; ?>' class="form-horizontal">
            <div class="modal-body">
    ...
    <script src="dist/js/custom/custom-responsive.js"></script>
  </body>
</html>
